...
FavoriteWorkOrder workOrderFromJson(String str) => FavoriteWorkOrder.fromJson(json.decode(str));

String workOrderToJson(FavoriteWorkOrder data) => json.encode(data.toJson());

class FavoriteWorkOrder {
  ...
  factory FavoriteWorkOrder.fromJson(Map<String, dynamic> json) => FavoriteWorkOrder(
