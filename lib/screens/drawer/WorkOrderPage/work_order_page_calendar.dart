...
import '../../../../utils/date_util.dart' as date_util;
import 'package:table_calendar/table_calendar.dart';
import '../../../../utils/extensions/colors_util.dart';
import '../../woroOrder/bloc/workorder_bloc.dart';
import '../../woroOrder/model/workorder.dart';


class WorkOrderCalendarPage extends StatefulWidget {
...
class _WorkOrderCalenderPageState extends State<WorkOrderCalendarPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<WorkorderBloc>(
      create: (context) => bloc..add(const GetWorkOrderEvent()),
      child: Scaffold(
        appBar: AppBar(
        ...
        body: BlocBuilder<WorkorderBloc, BaseState>(
          builder: (context, state) {
            ...
            if (state is SuccessState) {
              ...
              List<WorkorderEntity>? workOrderList = state.successResponse;
